...
export const RectangleStackIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M6.429 9.75L2.25 12l4.179 2.25m0-4.5l5.571 3 5.571-3m-11.142 0L2.25 7.5 12 2.25l9.75 5.25-5.571 3-5.571-3zM12 21.75l-9.75-5.25L12 11.25l9.75 5.25-9.75 5.25z" />
    </svg>
);

export const UsersIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.226c0 1.834 1.656 3.313 3.702 3.313a3.702 3.702 0 003.703-3.313M12 5.25a3 3 0 100 6 3 3 0 000-6zM3.75 18.72a9.094 9.094 0 013.742-.479 3 3 0 014.682-2.72m-7.5-2.226c0 1.834-1.656 3.313-3.702 3.313A3.702 3.702 0 012.25 13.5c0-1.834 1.656-3.313 3.702-3.313a3.702 3.702 0 013.703 3.313z" />
    </svg>
);
...
export const TrophyIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 18.75h-9a9 9 0 119 0zM16.5 18.75a9 9 0 00-9 0m9 0c.234 0 .44-.006.652-.018m-10.304 0c.212.012.418.018.652.018m9-9.75a.75.75 0 01.75-.75h.008a.75.75 0 01.75.75v.008a.75.75 0 01-.75.75H18a.75.75 0 01-.75-.75V9zm-11.25 0a.75.75 0 01.75-.75h.008a.75.75 0 01.75.75v.008a.75.75 0 01-.75.75H6.75a.75.75 0 01-.75-.75V9z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 14.25a3 3 0 100-6 3 3 0 000 6z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.75v1.5" />
    </svg>
);
...
export const DiamondIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.343 3.94c.09-.542.56-1.007 1.11-1.227l.11-.044a2.25 2.25 0 012.872-.001l.11.044c.55.22 1.02.685 1.11 1.227l.029.177 2.14 12.84c.09.542-.19 1.087-.68 1.41l.001.001-2.22 1.48a2.25 2.25 0 01-2.399 0l-2.22-1.48-.002-.001a1.5 1.5 0 01-.68-1.41l2.14-12.84.03-.177zM12 6.75a.75.75 0 01.75.75v6a.75.75 0 01-1.5 0v-6a.75.75 0 01.75-.75zm0 0a.75.75 0 00-1.06 0l-2.25 2.25a.75.75 0 000 1.06l2.25 2.25a.75.75 0 001.06 0l2.25-2.25a.75.75 0 000-1.06l-2.25-2.25z" />
    </svg>
);

export const VinylIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className={className || "w-6 h-6"}>
...
export const Bars4Icon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
...
export const CrownIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.362 5.214A8.252 8.252 0 0112 21 8.25 8.25 0 018.638 5.214M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 12v9" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.362 5.214C16.92 6.34 18.273 7.844 19.5 9.75M8.638 5.214C7.08 6.34 5.727 7.844 4.5 9.75" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M21 12c-1.227-1.906-2.58-3.41-4.138-4.536" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M3 12c1.227-1.906 2.58-3.41 4.138-4.536" />
  </svg>
);

export const BroadcastIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M19.114 5.636a9 9 0 010 12.728M4.886 5.636a9 9 0 0112.728 0M12 21a9 9 0 00-9-9 9 9 0 009-9 9 9 0 009 9 9 9 0 00-9 9zM12 12a3 3 0 100-6 3 3 0 000 6z" />
  </svg>
);
...
export const UserPlusIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M19 7.5v3m0 0v3m0-3h3m-3 0h-3m-2.25-4.125a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zM4 19.235v-.11a6.375 6.375 0 0112.75 0v.109A12.318 12.318 0 0110.5 21c-2.39 0-4.62-.609-6.5-1.666z" />
    </svg>
);
...
export const Cog6ToothIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-1.007 1.11-1.227l.11-.044a2.25 2.25 0 0 1 2.872 0l.11.044c.55.22 1.02.685 1.11 1.227l.029.177a11.965 11.965 0 0 1 3.413 1.023l.178.082a2.25 2.25 0 0 1 2.121 2.121l.082.178a11.965 11.965 0 0 1 1.023 3.413l.044.11a2.25 2.25 0 0 1 0 2.872l-.044.11a11.965 11.965 0 0 1-1.023 3.413l-.082.178a2.25 2.25 0 0 1-2.121 2.121l-.178.082a11.965 11.965 0 0 1-3.413 1.023l-.11.044a2.25 2.25 0 0 1-2.872 0l-.11-.044a11.965 11.965 0 0 1-3.413-1.023l-.178-.082a2.25 2.25 0 0 1-2.121-2.121l-.082-.178a11.965 11.965 0 0 1-1.023-3.413l-.044-.11a2.25 2.25 0 0 1 0 2.872l.044-.11a11.965 11.965 0 0 1 1.023-3.413l.082-.178a2.25 2.25 0 0 1 2.121-2.121l.178-.082a11.965 11.965 0 0 1 3.413-1.023l.11-.044zM12 8.25a3.75 3.75 0 1 0 0 7.5 3.75 3.75 0 0 0 0-7.5z" />
    </svg>
);
...
export const FaceSmileIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M14.828 14.828a4.072 4.072 0 0 1-5.656 0M9 10.5h.008v.008H9v-.008zm6 0h.008v.008H15v-.008z" />
...
export const HandThumbUpIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M6.633 10.5c.806 0 1.533-.425 2.031-1.08a9.041 9.041 0 012.861-2.4c.723-.384 1.35-.956 1.653-1.715a4.498 4.498 0 00.322-1.672V3a.75.75 0 01.75-.75A2.25 2.25 0 0116.5 4.5c0 1.152-.26 2.243-.723 3.218-.266.358.232.836.671.836h2.737a1.125 1.125 0 011.125 1.125v6.75a1.125 1.125 0 01-1.125 1.125h-2.737a1.125 1.125 0 01-.671-.208c-.44-.322-.972-.51-1.533-.51H9.33a4.5 4.5 0 00-4.5 4.5v2.25a.75.75 0 00.75.75h3.75a.75.75 0 00.75-.75V18a.75.75 0 00-.75-.75h-1.5a.75.75 0 00-.75.75v3a.75.75 0 00.75.75h9a.75.75 0 00.75-.75v-5.25a.75.75 0 00-.75-.75h-3.75a.75.75 0 01-.75-.75v-1.5a.75.75 0 01.75-.75Z" />
  </svg>
);
...
export const LightBulbIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-.189m-1.5.189a6.01 6.01 0 01-1.5-.189m3.75 7.478a12.06 12.06 0 01-4.5 0m3.75 2.311a.75.75 0 01-1.5 0m1.5 0a.75.75 0 00-1.5 0m-7.5-12.75h13.5A2.25 2.25 0 0019.5 6h-15a2.25 2.25 0 00-2.25 2.25v.75A2.25 2.25 0 004.5 11.25h15a2.25 2.25 0 002.25-2.25v-.75a2.25 2.25 0 00-2.25-2.25z" />
    </svg>
);

export const InfinityIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" transform="translate(0, 6) scale(1, -1) translate(0, -18)" />
...
export const SwordsIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M21 3l-6 6m0 0L3 21M15 9l6-6M9 3l12 12" />
    </svg>
);
...
export const FireIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.362 5.214A8.252 8.252 0 0112 21 8.25 8.25 0 018.638 5.214M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 18.75V9.75M15 12.75l-3 3-3-3" />
    </svg>
);
